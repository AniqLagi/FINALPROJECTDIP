...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['make'], $_POST['model'], $_POST['plate'], $_POST['password'])) {
        ...
        $repeatPassword = $_POST['repeat_password']; // Get repeated password entered by user
        if ($password !== $repeatPassword) {
            // $_SESSION['error'] = "";
            header("Location: addvehicle.php?error=1"); // Redirect back to the form with an error indicator
            exit();
        }
