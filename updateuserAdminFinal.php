...
if ($result->num_rows > 0) {
    ...
    $stmt->bind_param("ssssssi", $name, $username, $hashedPassword, $email, $phone, $usertype, $userid);

    $stmt->execute();

if($stmt->affected_rows > 0) {
    echo "<script>alert('Information Updated Successfully!'); window.location.href='admin.php';</script>";
    //echo "<meta http-equiv=\"refresh\" content=\"2;URL=admin.php\">";
} else {
    echo "<script>alert('Password do not matched!'); window.location.href='admin.php';</script>";
