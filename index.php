...
<html lang="en">
    ...
    <body>
        <header id="header">
            <div class="top-bar">
                <nav class="nav-bar">
                    <a href="index.php"><img src="assets/VETFinal.png" class="logo" alt="User profile"></a>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li><a href="Aboutus.html">About Us</a></li>
                        <?php
                        if (!isset($_SESSION['email']) && !isset($_SESSION['tutoremail'])) {
                            echo "<li><a href='Loginform.php'>Log In</a>";
        ...
        <div>
            <h1 style="color: white;" class="center"><font color ="white" size="7" font-family="Poppins">Vehicle Expenses Tracking System</font></h1>
            <h1 style="color: white;" class="center">Welcome to Vehicle Expenses Tracking System Website <?php echo date("Y"); ?></h1>
