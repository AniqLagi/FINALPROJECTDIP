...
$vehicleStmt = $conn->prepare("SELECT COUNT(*) AS total FROM vehicle");
$vehicleStmt->execute();
        ...
        <div class="card--container">
            ...
            <div class="payment--card">
                <div class="card--header">
                    <div class="amount">
                        <span class="title">Total of Registered Vehicke</span>
                    ...
                    <table>
                            ...
                            <tbody>
                                ...
                                if (empty($searchTerm)) {
                                    ...
                                    JOIN user_vehicle uv ON v.VehicleID = uv.VehicleID
                                    JOIN user u ON uv.UserID = u.UserID
                                    WHERE v.Make LIKE ? OR v.Model LIKE ? OR v.License_Plate LIKE ? AND uv.AccessRole = 'Owner'
                                    ");
